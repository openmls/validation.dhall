...
let descText =
      ...
      - When a LeafNode is received by a group member in an Add, Update, or Commit messageWhen a client validates a ratchet tree, e.g., when joining a group or after processing a Commit
      ''
