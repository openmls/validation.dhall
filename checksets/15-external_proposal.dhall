...
let checks =
      [ types.Check/new
          ...
          types.CodeRefs/empty
          (types.Notes/single "This is implicit, because it's the value on which our decision how to process the message is based.")
      , types.Check/new
          2
          ( types.RfcRef/new
              ''
          ...
          types.CodeRefs/empty
          types.CodeRefs/empty
          (types.Notes/single "Not all of the accepted proposal types are implemented yet.")
      , types.Check/new
          3
          ( types.RfcRef/new
              ''
